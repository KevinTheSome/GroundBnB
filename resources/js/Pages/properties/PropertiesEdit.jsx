            ...
            <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
                    <div className="w-full rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0 bg-cyan-600 border-cyan-900">
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <input value ={""} type="hidden" name="id" id="id" placeholder="a very nice small house to relax" className="bg-cyan-100 border border-cyan-900 text-cyan-900 sm:text-sm rounded-lg block w-full p-2.5 " required="" />
                                <div>
                                ...
                                <button type="submit" className="w-full text-white bg-cyan-500 hover:bg-cyan-400 focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center">Update property</button>
                            </form>
                        </div>
                    </div>
                </div>
